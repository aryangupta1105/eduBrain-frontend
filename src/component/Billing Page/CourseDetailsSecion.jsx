...
export const CourseDetailsSection = () => {
  ...
  return (
    <section className="flex flex-col w-[398px] items-start gap-[63px] relative">
      <article className="flex flex-col w-[361.51px] items-start gap-[13px] relative flex-[0_0_auto]">
        ...
        <div className="flex flex-col items-center relative self-stretch w-full flex-[0_0_auto] bg-[#0c0c0d] rounded-[6.93px] border-[0.87px] border-solid border-[#2d2d2d] shadow-[0px_0px_0px_transparent,0px_0px_0px_transparent,0px_8.66px_12.99px_-2.6px_#0000001a,0px_3.46px_5.19px_-3.46px_#0000001a]">
          <div className="relative self-stretch w-full h-[183.55px] rounded-[6.93px_6.93px_0px_0px] overflow-hidden bg-[url(/powerbi.png)] bg-cover bg-[50%_50%]">
            <div className="flex w-[333px] items-center justify-between relative top-2 left-3.5">
              <div className="inline-flex items-center justify-center gap-[6.93px] px-[8.66px] py-[4.33px] relative flex-[0_0_auto] bg-red-500 rounded-[3.46px] overflow-hidden">
                <span className="mt-[-0.69px] [font-family:'Roboto-Bold',Helvetica] font-bold text-white text-[9.7px] leading-[13.9px] relative w-fit tracking-[0] whitespace-nowrap">
                  10% OFF
                </span>
              </div>

              <div className="inline-flex items-center justify-center gap-[6.93px] px-[8.66px] py-[4.33px] relative flex-[0_0_auto] bg-white rounded-[3.46px] overflow-hidden">
                <span className="relative w-fit mt-[-0.87px] [font-family:'Roboto-Bold',Helvetica] font-bold text-[#000000] text-[9.7px] tracking-[0] leading-[13.9px] whitespace-nowrap">
                  Featured
                </span>
              </div>
            </div>
          ...
          <div className="flex flex-col items-start gap-[12.12px] px-[14.72px] py-[17.32px] relative self-stretch w-full flex-[0_0_auto]">
            <h2 className="relative w-[271.87px] mt-[-0.87px] [font-family:'Roboto-Medium',Helvetica] font-medium  text-[17.3px] tracking-[0] text-white leading-[15.6px] overflow-hidden text-ellipsis [display:-webkit-box] [-webkit-line-clamp:2] [-webkit-box-orient:vertical]">
