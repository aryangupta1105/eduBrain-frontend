...
function CourseCard() {
  ...
  return (
  <article className="w-full max-w-[406px] min-w-60 rounded-lg border border-solid shadow-sm bg-blend-normal bg-neutral-950 border-zinc-800 mx-auto
    md:max-w-full md:w-full md:min-w-0 md:mx-auto
    ">
        ...
        <div className="w-full">
          <div className="w-full">
            <div className="flex gap-2 items-end w-full whitespace-nowrap bg-blend-normal">
              <span className="text-lg sm:text-xl font-extrabold leading-snug text-white">
                ₹1299
              </span>
              <span className="text-xs sm:text-sm leading-6 line-through text-zinc-400">
                ₹2598
              </span>
            </div>
  ...
  <div className="mt-3.5 text-lg sm:text-xl font-medium leading-none text-white">
          ...
          {courseFeatures.map((feature, index) => (
            <div key={index} className="flex gap-1 items-center mt-1.5 first:mt-0">
              <img
                ...
                alt=""
              />
              <span className="self-stretch my-auto text-ellipsis text-zinc-400 w-full text-xs sm:text-sm">
                {feature}
              </span>
            </div>
          ))}
