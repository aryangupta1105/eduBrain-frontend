...
const CourseHeader = () => {
  return (
    <header className="flex justify-between items-center px-5 py-0 w-full rounded-2xl border border-blue-800 border-solid bg-blue-800 bg-opacity-10 h-[73px] max-md:flex-col max-md:gap-4 max-md:p-4 max-md:h-auto max-sm:p-2.5">
